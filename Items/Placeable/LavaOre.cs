...
namespace Theramium.Items.Placeable
{
	public class LavaOre : ModItem
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("'Is this from the hell or somewhere else?'");
		...
		public override void SetDefaults()
		{
			...
			item.createTile = mod.TileType("LavaOre");
		}
